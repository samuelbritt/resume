...
\cvitem{Proficient in}{Python (and SciPy), C, Git, Mercurial, Linux,
  Vim, \LaTeX.}
\cvitem{Exposure to}{\CC, Java, \matlab, \fortran, SQL, OpenMPI,
...
\cventry{2009--2011}
  ...
  {}
  {
    ...
    \begin{itemize}
      ...
      \item Administered the computer clusters used by all students in
        the research group.
    \end{itemize}
  }
