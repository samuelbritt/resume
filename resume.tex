...
\iftoggle{engineering}{
  ...
  \title{\normalsize Seeking to leverage an engineering background to
  pursue systems software develeopment through a passion for
  technology.}
}{}
...
\cvitem[\coursesep]{Computer Science}{Adv.\ Operating Systems,
  ...
  Real-Time Avionic Control Software.}
